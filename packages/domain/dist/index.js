...
var Commande = class {
  constructor(id, clientId, restaurantId, articles, prixPlats, fraisLivraison, fraisService, adresseLivraison, reduction = Money.zero()) {
    this.id = id;
...
var Livreur = class {
  constructor(id, nom, position, telephone, estExpert = false, portefeuille = Money.zero(), propositionsIds = []) {
    this.id = id;
    this.nom = nom;
    this.position = position;
    this.telephone = telephone;
