...
export declare class Commande {
    ...
    private readonly positionLivraison;
    private readonly reduction;
    private statut;
    private tempsPreparationEstime;
    private livreurId;
    private readonly creeLe;
    constructor(id: string, clientId: string, restaurantId: string, articles: ArticlePanier[], prixPlats: Money, fraisLivraison: Money, fraisService: Money, adresseLivraison: string, positionLivraison: Coordonnees, reduction?: Money, creeLe?: Date);
