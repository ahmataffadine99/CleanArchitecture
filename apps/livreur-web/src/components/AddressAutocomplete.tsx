    ...
    <div className={`relative ${className}`} ref={wrapperRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-6 py-4 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white rounded-2xl outline-none transition-all font-bold text-slate-700 placeholder:text-slate-300"
          autoComplete="off"
        />
      </div>
